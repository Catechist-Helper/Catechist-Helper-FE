...
const CreateCertificate: React.FC = () => {
    ...
    const [certificateData, setCertificateData] = useState<CertificateResponse & { levelName?: string }>({
        name: "",
        description: "",
        image: "",
        levelId: "",
        ...
        if (canvas) {
            ...
            if (ctx) {
                ...
                backgroundImage.onload = () => {
                    ...
                    ctx.font = "16px Arial";
                    ctx.fillStyle = "#555";
                    ctx.fillText("This certificate is proudly presented for honorable achievement to", canvas.width / 2, 180);
                    ...
                    ctx.font = "18px Arial";
                    ctx.fillStyle = "#333";
                    ctx.fillText(certificateData.description || "", canvas.width / 2, 400);
    ...
    }, [certificateData.name, certificateData.description, certificateData.levelId, certificateData.levelName]);
    ...
    const validationSchema = Yup.object({
        name: Yup.string().required("Tên chứng chỉ không được bỏ trống.").max(100, "Tên không được quá 100 ký tự."),
        description: Yup.string().required("Mô tả không được bỏ trống.").max(500, "Mô tả không được quá 500 ký tự."),
                    ...
                    <form onSubmit={formik.handleSubmit} className="max-w-sm mx-auto mt-5">
                        ...
                        <div className="mb-5">
                            ...
                            {formik.errors.levelId && formik.touched.levelId ? (
                                <div className="text-red-500 text-sm">{formik.errors.levelId}</div>
                            ) : null}
                        </div>
