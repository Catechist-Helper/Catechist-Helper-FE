                ...
                <div className="flex items-center justify-end space-x-4 p-5">
                    ...
                    <div className="d-flex">
                        {postCategories.map((category: any) => (
                            <button key={category.id} className="btn btn-outline-primary mx-2">
                                {category.name}
                            </button>
                        ))}
                    </div>
                    ...
                    <div className="relative">
                        ...
                        />
                        <AiOutlineSearch className="absolute right-3 top-2.5 text-gray-500" size={20} />
                    </div>
                    <div className="relative">
                        <input
                            type="date"
                            ...
                            className="pl-4 pr-10 py-2 rounded-lg bg-gray-100 border focus:outline-none focus:ring-2 focus:ring-gray-400"
                        />
                        <AiOutlineCalendar className="absolute right-3 top-2.5 text-gray-500" size={20} />
                    </div>

                    
                    <button className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-2 px-6 rounded-full" onClick={handleCreatePost}>
                        Tạo bài mới
                    </button>
