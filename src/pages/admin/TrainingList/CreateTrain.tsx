                ...
                <form onSubmit={formik.handleSubmit} className="max-w-sm mx-auto mt-5">
                        ...
                        <div className="flex items-center space-x-4 rtl:space-x-reverse mb-3">
                            <div className="flex items-center w-full">
                                <input
                                    ...
                                    name="startTime"
                                    type="datetime-local"
                                    className={`text-gray-900 dark:text-white text-base font-medium block w-full border ${formik.errors.startTime ? "border-red-500" : "border-gray-300"
                                        } rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-500 dark:focus:border-blue-500`}
                                    onChange={formik.handleChange}
                        ...
                        <div className="flex items-center space-x-4 rtl:space-x-reverse mb-3">
                            <div className="flex items-center w-full">
                                <input
                                    ...
                                    name="endTime"
                                    type="datetime-local"
                                    className={`text-gray-900 dark:text-white text-base font-medium block w-full border ${formik.errors.endTime ? "border-red-500" : "border-gray-300"
                                        } rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-500 dark:focus:border-blue-500`}
                                    onChange={formik.handleChange}
                    ...
                    <div className="flex items-start mb-5">
                        <button
                            ...
                            className={`text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center ${Object.keys(formik.errors).length > 0 || isSubmitting ? "opacity-50 cursor-not-allowed" : ""
                                }`}
                        >
