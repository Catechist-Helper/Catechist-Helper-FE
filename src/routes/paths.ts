...
export const PATH_ADMIN = {
  ...
  // Thuan
  admin_catechist_management: path(PATH_ROOT_ADMIN, "/catechists"),
  admin_registration: path(PATH_ROOT_ADMIN, "/registrations"),
  admin_approved_registration: path(PATH_ROOT_ADMIN, "/interviews"),
  admin_major_management: path(PATH_ROOT_ADMIN, "/majors"),
  admin_grade_management: path(PATH_ROOT_ADMIN, "/grades"),
  admin_class_management: path(PATH_ROOT_ADMIN, "/classes"),
  admin_assign_catechist_to_grade: path(PATH_ROOT_ADMIN, "/grades/assign-catechists"),
  admin_event_category_management: path(PATH_ROOT_ADMIN, "/event-categories"),
  admin_event_management: path(PATH_ROOT_ADMIN, "/events"),
  admin_event_process_management: path(PATH_ROOT_ADMIN, "/event-processes"),
...
export const PATH_HOME = {
  ...
  introduction: path(PATH_ROOT_HOME, "introduction"),
};
